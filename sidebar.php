...
<div id="sidebar sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
...
?>
  ...
  <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
                ...
                <ul class="children collapse" id="sub-item-2">
                    <li><a class="" href="expense-datewise-reports">
                        <span class="fa fa-arrow-right">&nbsp;</span> Daywise Expenses
                    </a></li>
                    <li><a class="" href="expense-monthwise-reports">
                        <span class="fa fa-arrow-right">&nbsp;</span> Monthwise Expenses
                    </a></li>
                    <li><a class="" href="expense-yearwise-reports">
