...
<nav class="navbar navbar-custom navbar-fixed-top bg-black" role="navigation">
	...
	<hr />
        <div class="row">
            <p align="center">Before Registering to this system you can use this demo mail id and password to understand the working nature of this Expense Tracker.</p>
            <b><p align="center"> Demo Email : demo@gmail.com </p></b>
            <b><p align="center"> Demo Password : demopassword </p></b>
        </div>
    ...
    echo $msg;
						...
						<fieldset>
							...
							<div class="checkbox">
								<button type="submit" value="submit" name="submit" class="btn btn-warning">Register</button><span style="padding-left:250px">
								<a href="login" class="btn btn-warning">Login</a></span>
							</div>
							 </fieldset>
					</form>
				</div>
